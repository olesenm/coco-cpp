...
=head1 NAME
X<coco-cpp> X<Compiler Generator>

coco-cpp - The Compiler Generator Coco/R, C++ version.

=head1 SYNOPSIS

coco-cpp [OPTION] Grammar.atg
...
include C<< #line >> pragmas in the generated code

=item -single

Combine the Scanner code into the Parser file. This can be useful when
writing makefiles since it permits a single make target.
...
First port to C++ by Csaba Balazs.
