...
Source0: https://github.com/downloads/olesenm/coco-cpp/coco-cpp-%{version}.tar.gz
...
%files
%defattr(-,root,root)
%doc COPYING README.mkdn NOTES.mkdn src/Coco-cpp.atg
%{_bindir}/*
%{_datadir}/*
